---
id: 03-parsia-afzar
company_fa: پارسیا افزار فرااندیشان نوین
company_en: ParsiaAfzar FaraAndishanNovin
role_fa: پشتیبانی و توسعه اتوماسیون توزیع برق؛ بازنویسی میکروسرویس
role_en: Electricity-distribution automation support and development; microservices rewrite
period_fa: مهر ۱۳۹۹ – دی ۱۴۰۱
...
learning_alongside:
  ...
  - Trading
metrics:
  - "پشتیبانی و رفع اشکال اتوماسیون MVC توزیع برق (بوشهر، مازندران، تهران بزرگ، اراک و شهرهای دیگر) از مسیر تیکت و توسعه"
  - "پیشنهاد و پیاده‌سازی بازنویسی یکپارچه اتوماسیون با Microservices، CQRS، RabbitMQ، DDD، Vue.js، Monitoring و .NET Core"
  - "CMS اختصاصی سایت شرکت با ASP.NET Core MVC"
related_certificates:
  - aspnet-core-mvc
  - oop-csharp
---

# پارسیا افزار فرااندیشان نوین | ParsiaAfzar FaraAndishanNovin

**نقش:** پشتیبانی و توسعه اتوماسیون توزیع برق؛ بازنویسی میکروسرویس / Electricity-distribution automation support and development; microservices rewrite  
