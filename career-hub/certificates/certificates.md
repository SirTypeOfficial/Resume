...
PDF هنوز در `assets/` نیست. روایت: [مسیر آموزشی](../education/00-training-path.md). بک‌اند محصول [07 عیار پلاس](../experiences/07-ayar-plus.md) PHP بود (اتصال از کلاینت MAUI؛ CodeIgniter در آن نقش ذکر نشده). به استک تولید نیکان، رستا یا پارسیا وصل نشده.
